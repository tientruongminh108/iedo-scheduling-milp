...
# Stage 1 minimizes tardy jobs, Stage 2 fixes that count and minimizes makespan.
def solve_milp(instance: Instance, time_limit_ms: int = 30000) -> Dict[str, Any]:
    # Split time limit equally between the two stages
...
# Entry point
def solve_instance(instance: Instance, time_limit_ms: int = 300000) -> Dict[str, Any]:
    return solve_milp(instance, time_limit_ms=time_limit_ms)